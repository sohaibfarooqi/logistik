import pytest
from ..logistik.app import init_app, db
from ..logistik.models import Order, Sku, Storage, OrderLine
...
def simple_order():
  ...
  order_line = create_model_obj(OrderLine, {"order":  order, "sku": sku, "quantity": 5})
